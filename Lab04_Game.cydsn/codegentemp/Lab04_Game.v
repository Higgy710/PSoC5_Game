// ======================================================================
// Lab04_Game.v generated from TopDesign.cysch
// 03/24/2021 at 18:14
...
module top ;
    ...
    Timer_v2_80_0 Refresh_Timer (
        ...
        .tc(Net_7),
        .clock(Net_10));
    defparam Refresh_Timer.CaptureCount = 2;
    defparam Refresh_Timer.CaptureCounterEnabled = 0;
    defparam Refresh_Timer.DeviceFamily = "PSoC5";
    defparam Refresh_Timer.InterruptOnCapture = 0;
    defparam Refresh_Timer.InterruptOnTC = 1;
    defparam Refresh_Timer.Resolution = 16;
    defparam Refresh_Timer.SiliconRevision = "0";
	...
	wire [1:0] tmpOE__Control_net;
	wire [1:0] tmpFB_1__Control_net;
	wire [1:0] tmpIO_1__Control_net;
	...
	cy_psoc3_pins_v1_10
		...
		Control
		 (.oe(tmpOE__Control_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__Control_net[1:0]}),
		  .io({tmpIO_1__Control_net[1:0]}),
	...
	assign tmpOE__Control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
