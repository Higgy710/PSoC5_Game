...
{
    uint8 staticBits = (Control_DR & (uint8)(~Control_MASK));
    Control_DR = staticBits | ((uint8)(value << Control_SHIFT) & Control_MASK);
}
...
{
	CyPins_SetPinDriveMode(Control_0, mode);
	CyPins_SetPinDriveMode(Control_1, mode);
}
...
{
    return (Control_PS & Control_MASK) >> Control_SHIFT;
}
...
{
    return (Control_DR & Control_MASK) >> Control_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Control_0_INTR) != 0u) 
		{ 
			 Control_0_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Control_1_INTR) != 0u) 
		{ 
			 Control_1_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Control_INTSTAT & Control_MASK) >> Control_SHIFT;
    }
